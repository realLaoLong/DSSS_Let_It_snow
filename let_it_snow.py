...
def main(speed=0, bg_color="white"):
    ...
    # list with colors to be used for the snowflakes
    ...
    for _ in range(10):
        ...
        # Randomly choose a color from color list
        color_index = np.random.randint(len(color_list))
        myTurtle.pencolor(color_list[color_index])
